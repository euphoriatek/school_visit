...
var routes = [
    ...
    {
        path: 'login',
        loadChildren: function () { return __webpack_require__.e(/*! import() | page-login-login-module */ "page-login-login-module").then(__webpack_require__.bind(null, /*! ./page/login/login.module */ "./src/app/page/login/login.module.ts")).then(function (m) { return m.LoginPageModule; }); }
    },
    {
        path: 'purpose',
        loadChildren: function () { return __webpack_require__.e(/*! import() | page-purpose-purpose-module */ "page-purpose-purpose-module").then(__webpack_require__.bind(null, /*! ./page/purpose/purpose.module */ "./src/app/page/purpose/purpose.module.ts")).then(function (m) { return m.PurposePageModule; }); }
    },
    {
        path: 'scan-code',
        loadChildren: function () { return __webpack_require__.e(/*! import() | page-scan-code-scan-code-module */ "page-scan-code-scan-code-module").then(__webpack_require__.bind(null, /*! ./page/scan-code/scan-code.module */ "./src/app/page/scan-code/scan-code.module.ts")).then(function (m) { return m.ScanCodePageModule; }); }
    },
    {
        path: 'confirm-sign',
        loadChildren: function () { return __webpack_require__.e(/*! import() | page-confirm-sign-confirm-sign-module */ "page-confirm-sign-confirm-sign-module").then(__webpack_require__.bind(null, /*! ./page/confirm-sign/confirm-sign.module */ "./src/app/page/confirm-sign/confirm-sign.module.ts")).then(function (m) { return m.ConfirmSignPageModule; }); }
    },
    {
        path: 'thanks-for-sign',
        loadChildren: function () { return __webpack_require__.e(/*! import() | page-thanks-for-sign-thanks-for-sign-module */ "page-thanks-for-sign-thanks-for-sign-module").then(__webpack_require__.bind(null, /*! ./page/thanks-for-sign/thanks-for-sign.module */ "./src/app/page/thanks-for-sign/thanks-for-sign.module.ts")).then(function (m) { return m.ThanksForSignPageModule; }); }
    },
    {
        path: 'camera',
        loadChildren: function () { return Promise.all(/*! import() | page-camera-camera-module */[__webpack_require__.e("common"), __webpack_require__.e("page-camera-camera-module")]).then(__webpack_require__.bind(null, /*! ./page/camera/camera.module */ "./src/app/page/camera/camera.module.ts")).then(function (m) { return m.CameraPageModule; }); }
    },
    {
        path: 'work-with-child',
        loadChildren: function () { return __webpack_require__.e(/*! import() | page-work-with-child-work-with-child-module */ "page-work-with-child-work-with-child-module").then(__webpack_require__.bind(null, /*! ./page/work-with-child/work-with-child.module */ "./src/app/page/work-with-child/work-with-child.module.ts")).then(function (m) { return m.WorkWithChildPageModule; }); }
    },
    {
        path: 'info',
        loadChildren: function () { return Promise.all(/*! import() | page-info-info-module */[__webpack_require__.e("common"), __webpack_require__.e("page-info-info-module")]).then(__webpack_require__.bind(null, /*! ./page/info/info.module */ "./src/app/page/info/info.module.ts")).then(function (m) { return m.InfoPageModule; }); }
    },
    {
        path: 'contract',
        loadChildren: function () { return __webpack_require__.e(/*! import() | page-contract-contract-module */ "page-contract-contract-module").then(__webpack_require__.bind(null, /*! ./page/contract/contract.module */ "./src/app/page/contract/contract.module.ts")).then(function (m) { return m.ContractPageModule; }); }
    },
    {
        path: 'ty-enjoyday',
        loadChildren: function () { return __webpack_require__.e(/*! import() | page-ty-enjoyday-ty-enjoyday-module */ "page-ty-enjoyday-ty-enjoyday-module").then(__webpack_require__.bind(null, /*! ./page/ty-enjoyday/ty-enjoyday.module */ "./src/app/page/ty-enjoyday/ty-enjoyday.module.ts")).then(function (m) { return m.TyEnjoydayPageModule; }); }
    },
    {
        path: 'logout',
        loadChildren: function () { return __webpack_require__.e(/*! import() | page-logout-logout-module */ "page-logout-logout-module").then(__webpack_require__.bind(null, /*! ./page/logout/logout.module */ "./src/app/page/logout/logout.module.ts")).then(function (m) { return m.LogoutPageModule; }); }
    },
    {
        path: 'yourname',
        loadChildren: function () { return __webpack_require__.e(/*! import() | page-yourname-yourname-module */ "page-yourname-yourname-module").then(__webpack_require__.bind(null, /*! ./page/yourname/yourname.module */ "./src/app/page/yourname/yourname.module.ts")).then(function (m) { return m.YournamePageModule; }); }
    },
    {
        path: 'name',
        loadChildren: function () { return __webpack_require__.e(/*! import() | page-name-name-module */ "page-name-name-module").then(__webpack_require__.bind(null, /*! ./page/name/name.module */ "./src/app/page/name/name.module.ts")).then(function (m) { return m.NamePageModule; }); }
    },
    {
        path: 'where',
        loadChildren: function () { return __webpack_require__.e(/*! import() | page-where-where-module */ "page-where-where-module").then(__webpack_require__.bind(null, /*! ./page/where/where.module */ "./src/app/page/where/where.module.ts")).then(function (m) { return m.WherePageModule; }); }
    },
];
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            entryComponents: [],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_9__["AppRoutingModule"], angularx_qrcode__WEBPACK_IMPORTED_MODULE_11__["QRCodeModule"], ngx_qrcode2__WEBPACK_IMPORTED_MODULE_12__["NgxQRCodeModule"], _ionic_storage__WEBPACK_IMPORTED_MODULE_13__["IonicStorageModule"].forRoot()],
            providers: [
...
module.exports = __webpack_require__(/*! /Users/ignisit/Documents/projects/visitor_app/src/main.ts */"./src/main.ts");
