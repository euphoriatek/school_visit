...
var ScanCodePageRoutingModule = /** @class */ (function () {
    function ScanCodePageRoutingModule() {
    }
    ...
    return ScanCodePageRoutingModule;
}());
...
var ScanCodePage = /** @class */ (function () {
    function ScanCodePage(qrScanner, platform, navCtrl, router) {
    ...
    ScanCodePage.prototype.createCode = function () {
    ...
    ScanCodePage.prototype.scanQRCode = function () {
        var _this = this;
        this.qrScanner.prepare().then(function (status) {
            if (status.authorized) {
                ...
                // start scanning
                _this.scanning = _this.qrScanner.scan().subscribe(function (textFound) {
                    console.log('Scanned something', textFound);
                    document.getElementsByTagName("body")[0].style.opacity = "1";
                    _this.scanning.unsubscribe();
                    console.log(textFound);
                    alert(textFound);
                    _this.Qrvalue = textFound;
                    _this.router.navigateByUrl('/ty-enjoyday');
                }, function (err) {
                });
            }
    ...
    ScanCodePage.prototype.ngOnInit = function () {
    };
    ScanCodePage.ctorParameters = function () { return [
...
//# sourceMappingURL=page-scan-code-scan-code-module-es5.js.map