...
var NamePageRoutingModule = /** @class */ (function () {
    function NamePageRoutingModule() {
    }
...
var NamePage = /** @class */ (function () {
    function NamePage(storage) {
        this.storage = storage;
        this.storage.set('userDataName', this.userName);
    }
    NamePage.prototype.ngOnInit = function () {
    };
    NamePage.ctorParameters = function () { return [
...
//# sourceMappingURL=page-name-name-module-es5.js.map